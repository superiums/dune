...
impl Expression {
    ...
    pub fn type_name(&self) -> &'static str {
        match self {
            ...
            Self::StringSafe(_) => "StringSafe",
            Self::StringTemplate(_) => "StringTemplate",
            ...
            Self::Pipe(_, _, _) => "Pipe",
            Self::UnaryOp(..) => "UnaryOp",
            Self::Bytes(_) => "Bytes",
            Self::Index(_, _) => "Index",
            Self::Property(_, _) => "Property",
            Self::Del(_) => "Del",
            Self::Declare(_, _) => "Declare",
            Self::SetParent(_, _) => "Set",
            Self::Export(_, _) => "Export",
            Self::Assign(_, _) => "Assign",
            Self::For(..) => "For",
            Self::While(_, _) => "While",
            Self::Loop(_) => "Loop",
            Self::Match(_, _) => "Match",
            Self::If(_, _, _) => "If",
            Self::Apply(_, _) => "Apply",
            Self::Command(_, _) => "Command",
            Self::SymbolRaw(_) => "SymboRaw",
            Self::ModuleCall(_, _) => "ModuleCall",
            Self::Lambda(..) => "Lambda",
            // Self::Macro(_, _) => "Macro",
            ...
            Self::Range(..) => "Range",
            Self::Chain(_, _) => "Chain",
            Self::PipeMethod(_, _) => "PipeMethod",
            Self::DestructureAssign(_, _) => "DestructureAssign",

            // Self::Error { .. } => "Error",
            Self::Use(..) => "Use",
            Self::TimeDef(..) => "TimeDef",
            Self::RegexDef(..) => "RegexDef",
            Self::Regex(..) => "Regex",
